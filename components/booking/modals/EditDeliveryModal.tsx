...
export interface EditDeliveryModalProps {
  booking: Booking;
  delivery: Delivery;
  onConfirm: (tubesDelivered: number, note: string) => Promise<void> | void;
  onCancel: () => void;
...
export function EditDeliveryModal({ booking, delivery, onConfirm, onCancel, isMobile }: EditDeliveryModalProps) {

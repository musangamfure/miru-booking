...
export interface BookingFormProps {
  ...
  setForm: (form: BookingFormData) => void;
  editId: string | null;
  onSave: (form: BookingFormData) => void;
  onCancel: () => void;
  saving: boolean;
}
...
export function BookingForm({ form, setForm, editId, onSave, onCancel, saving }: BookingFormProps) {
  ...
  const validate = (): boolean => {
    ...
    if (!form.tubes || isNaN(Number(form.tubes)) || Number(form.tubes) <= 0)
